...
class TwitterData:
    def parse_config(self):
        ...
        if os.path.exists('config.json'):
            ...
            parser.add_argument('-ck', '--consumer_key', default=None, help='Your developper B6tZdUyY6vHnMWYW79J9sUZzS')
            parser.add_argument('-cs', '--consumer_secret', default=None, help='Your developper F6n10hAo2n8VQFSNQEXliLCNRxjtJwshInF6A95RbZoUViaYOA')
            parser.add_argument('-at', '--access_token', default=None, help='A client 787526326018117632-KlRhZDNMxddJQJsHvpDZYMmz5cUaJiX')
            parser.add_argument('-ats', '--access_token_secret', default=None, help='A client VBspTZpYNjQ7A1nxrZWB8Mp6rJCzBlUB7rPFismnmDzNK')
